...
from transformers import TrainingArguments, Trainer, \
    MobileViTForSemanticSegmentation, AutoImageProcessor
import evaluate
...
DEFAULT_BACKBONE = "apple/deeplabv3-mobilevit-small"
...
class MVTVModelWrapper(BaseModelWrapper):
    ...
    def __init__(self, model_path):
        ...
        self.model = MobileViTForSemanticSegmentation\
...
if __name__ == '__main__':
    ...
    with mlflow.start_run(run_name='Finetuning',
        ...
        train_ds.processor = AutoImageProcessor\
