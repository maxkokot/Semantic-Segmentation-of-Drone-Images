...
from transformers import TrainingArguments, Trainer, \
    MobileViTV2ForSemanticSegmentation, AutoImageProcessor
import evaluate
...
DEFAULT_BACKBONE = "apple/mobilevitv2-1.0-imagenet1k-256"
...
class MVTVModelWrapper(BaseModelWrapper):
    '''Custom wrapper for the model'''
    def __init__(self, model_path):
        super(MVTVModelWrapper, self).__init__()
        self.model = MobileViTV2ForSemanticSegmentation\
...
class SegmentationPyFuncModel(mlflow.pyfunc.PythonModel):
    ...
    def load_context(self, context):
        self.wrapper = MVTVModelWrapper(context
...
if __name__ == '__main__':
    ...
    with mlflow.start_run(run_name='Finetuning',
        ...
        train_ds.processor = AutoImageProcessor.from_pretrained(backbone)
        test_ds.processor = AutoImageProcessor.from_pretrained(backbone)
        ...
        wrapped_model = MVTVModelWrapper(MODEL_TMP_DIR)
